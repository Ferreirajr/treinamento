...
<body>
    ...
    <div class="card mb-3 mx-auto" style="max-width: 35rem">
      <h5 class="card-header text-white bg-info">Cadastrar Produtos</h5>
      <div class="card-body">
            ...
            <div class="form-floating ">
                <div class="form-check">
                    @foreach($categorias ?? '' as $item)
                        <input class="form-check-input" name="categorias[{{$item->id}}]" id="categoria_id" type="checkbox" value="{{$item->id}}" >
