...
<body>
  ...
  <div class="container">
    ...
    <div class="card mb-3 mx-auto" style="max-width: 48rem">
      <h5 class="card-header text-white bg-info">Categorias Cadastradas</h5>
      <div class="card-body">
        ...
        <table class="table table-bordered">
          <thead>
            <tr>
              ...
              <th scope="col" style="width: 30%">Data de Criação</th>
          ...
          <tbody>
            ...
            @foreach ($categorias ?? '' as $item)
              <tr>
                ...
                <td>
                  <a class="btn btn-danger" href="{{route('categorias.destroy',$item->id)}}">
